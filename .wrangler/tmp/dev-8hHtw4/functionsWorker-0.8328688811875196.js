...
// .wrangler/tmp/pages-MfGU4s/functionsWorker-0.8328688811875196.mjs
...
__name(global_default, "global_default");
__name2(global_default, "default");
var PJD_3PARAM = 1;
var PJD_7PARAM = 2;
var PJD_GRIDSHIFT = 3;
var PJD_WGS84 = 4;
...
function projString_default(defData) {
  ...
  var params2 = {
    proj: "projName",
    datum: "datumCode",
    rf: /* @__PURE__ */ __name2(function(v) {
      self.rf = parseFloat(v);
    }, "rf"),
    lat_0: /* @__PURE__ */ __name2(function(v) {
      self.lat0 = v * D2R;
    }, "lat_0"),
    lat_1: /* @__PURE__ */ __name2(function(v) {
      self.lat1 = v * D2R;
    }, "lat_1"),
    lat_2: /* @__PURE__ */ __name2(function(v) {
      self.lat2 = v * D2R;
    }, "lat_2"),
    lat_ts: /* @__PURE__ */ __name2(function(v) {
      self.lat_ts = v * D2R;
    }, "lat_ts"),
    lon_0: /* @__PURE__ */ __name2(function(v) {
      self.long0 = v * D2R;
    }, "lon_0"),
    lon_1: /* @__PURE__ */ __name2(function(v) {
      self.long1 = v * D2R;
    }, "lon_1"),
    lon_2: /* @__PURE__ */ __name2(function(v) {
      self.long2 = v * D2R;
    }, "lon_2"),
    alpha: /* @__PURE__ */ __name2(function(v) {
      self.alpha = parseFloat(v) * D2R;
    }, "alpha"),
    gamma: /* @__PURE__ */ __name2(function(v) {
      self.rectified_grid_angle = parseFloat(v) * D2R;
    }, "gamma"),
    lonc: /* @__PURE__ */ __name2(function(v) {
      self.longc = v * D2R;
    }, "lonc"),
    x_0: /* @__PURE__ */ __name2(function(v) {
      self.x0 = parseFloat(v);
    }, "x_0"),
    y_0: /* @__PURE__ */ __name2(function(v) {
      self.y0 = parseFloat(v);
    }, "y_0"),
    k_0: /* @__PURE__ */ __name2(function(v) {
      self.k0 = parseFloat(v);
    }, "k_0"),
    k: /* @__PURE__ */ __name2(function(v) {
      self.k0 = parseFloat(v);
    }, "k"),
    a: /* @__PURE__ */ __name2(function(v) {
      self.a = parseFloat(v);
    }, "a"),
    b: /* @__PURE__ */ __name2(function(v) {
      self.b = parseFloat(v);
    }, "b"),
    r: /* @__PURE__ */ __name2(function(v) {
      self.a = self.b = parseFloat(v);
    }, "r"),
    r_a: /* @__PURE__ */ __name2(function() {
      self.R_A = true;
    }, "r_a"),
    zone: /* @__PURE__ */ __name2(function(v) {
      self.zone = parseInt(v, 10);
    }, "zone"),
    south: /* @__PURE__ */ __name2(function() {
      self.utmSouth = true;
    }, "south"),
    towgs84: /* @__PURE__ */ __name2(function(v) {
      self.datum_params = v.split(",").map(function(a) {
        return parseFloat(a);
      });
    }, "towgs84"),
    to_meter: /* @__PURE__ */ __name2(function(v) {
      self.to_meter = parseFloat(v);
    }, "to_meter"),
    units: /* @__PURE__ */ __name2(function(v) {
      self.units = v;
    ...
    from_greenwich: /* @__PURE__ */ __name2(function(v) {
      self.from_greenwich = v * D2R;
    }, "from_greenwich"),
    pm: /* @__PURE__ */ __name2(function(v) {
      var pm = match(PrimeMeridian_default, v);
      self.from_greenwich = (pm ? pm : parseFloat(v)) * D2R;
    }, "pm"),
    nadgrids: /* @__PURE__ */ __name2(function(v) {
      if (v === "@null") {
        self.datumCode = "none";
      } else {
        self.nadgrids = v;
    ...
    axis: /* @__PURE__ */ __name2(function(v) {
      var legalAxis = "ewnsud";
      if (v.length === 3 && legalAxis.indexOf(v.substr(0, 1)) !== -1 && legalAxis.indexOf(v.substr(1, 1)) !== -1 && legalAxis.indexOf(v.substr(2, 1)) !== -1) {
        self.axis = v;
      }
    }, "axis"),
    approx: /* @__PURE__ */ __name2(function() {
      self.approx = true;
    }, "approx"),
    over: /* @__PURE__ */ __name2(function() {
      self.over = true;
    }, "over")
  };
...
__name(projString_default, "projString_default");
__name2(projString_default, "default");
var PROJJSONBuilderBase = class {
  static {
    __name(this, "PROJJSONBuilderBase");
  }
  static {
    __name2(this, "PROJJSONBuilderBase");
  }
  static getId(node) {
...
var PROJJSONBuilder2015 = class extends PROJJSONBuilderBase_default {
  static {
    __name(this, "PROJJSONBuilder2015");
  }
  static {
    __name2(this, "PROJJSONBuilder2015");
  }
  static convert(node, result = {}) {
...
var PROJJSONBuilder2019 = class extends PROJJSONBuilderBase_default {
  static {
    __name(this, "PROJJSONBuilder2019");
  }
  static {
    __name2(this, "PROJJSONBuilder2019");
  }
  static convert(node, result = {}) {
    super.convert(node, result);
    const csNode = node.find((child) => Array.isArray(child) && child[0] === "CS");
...
__name(detectWKT2Version, "detectWKT2Version");
__name2(detectWKT2Version, "detectWKT2Version");
...
__name(buildPROJJSON, "buildPROJJSON");
__name2(buildPROJJSON, "buildPROJJSON");
...
__name(detectWKTVersion, "detectWKTVersion");
__name2(detectWKTVersion, "detectWKTVersion");
...
__name(applyProjectionDefaults, "applyProjectionDefaults");
__name2(applyProjectionDefaults, "applyProjectionDefaults");
...
__name(processUnit, "processUnit");
__name2(processUnit, "processUnit");
...
__name(calculateEllipsoid, "calculateEllipsoid");
__name2(calculateEllipsoid, "calculateEllipsoid");
...
__name(transformPROJJSON, "transformPROJJSON");
__name2(transformPROJJSON, "transformPROJJSON");
var knownTypes = [
  "PROJECTEDCRS",
  "PROJCRS",
  "GEOGCS",
...
__name(cleanWKT, "cleanWKT");
__name2(cleanWKT, "cleanWKT");
function setPropertiesFromWkt(wkt) {
  ...
  __name(toMeter, "toMeter");
  __name2(toMeter, "toMeter");
  var renamer = /* @__PURE__ */ __name2(function(a) {
    return rename(wkt, a);
  }, "renamer");
  var list = [
...
__name(setPropertiesFromWkt, "setPropertiesFromWkt");
__name2(setPropertiesFromWkt, "setPropertiesFromWkt");
...
__name(wkt_parser_default, "wkt_parser_default");
__name2(wkt_parser_default, "default");
function defs(name) {
  var that = this;
...
__name(testObj, "testObj");
__name2(testObj, "testObj");
function testDef(code) {
  return code in defs_default;
}
__name(testDef, "testDef");
__name2(testDef, "testDef");
function testWKT(code) {
  return code.indexOf("+") !== 0 && code.indexOf("[") !== -1 || typeof code === "object" && !("srsCode" in code);
}
__name(testWKT, "testWKT");
__name2(testWKT, "testWKT");
...
__name(checkMercator, "checkMercator");
__name2(checkMercator, "checkMercator");
...
__name(checkProjStr, "checkProjStr");
__name2(checkProjStr, "checkProjStr");
function testProj(code) {
  return code[0] === "+";
}
__name(testProj, "testProj");
__name2(testProj, "testProj");
function parse(code) {
  let out;
  if (testObj(code)) {
    if (testDef(code)) {
...
__name(extend_default, "extend_default");
__name2(extend_default, "default");
function msfnz_default(eccent, sinphi, cosphi) {
  var con = eccent * sinphi;
  return cosphi / Math.sqrt(1 - con * con);
}
__name(msfnz_default, "msfnz_default");
__name2(msfnz_default, "default");
function sign_default(x) {
  return x < 0 ? -1 : 1;
}
__name(sign_default, "sign_default");
__name2(sign_default, "default");
...
__name(adjust_lon_default, "adjust_lon_default");
__name2(adjust_lon_default, "default");
...
__name(tsfnz_default, "tsfnz_default");
__name2(tsfnz_default, "default");
...
__name(phi2z_default, "phi2z_default");
__name2(phi2z_default, "default");
function init() {
...
__name(getNormalizedProjName, "getNormalizedProjName");
__name2(getNormalizedProjName, "getNormalizedProjName");
function get(name) {
  if (!name) {
    return false;
  }
...
__name(eccentricity, "eccentricity");
__name2(eccentricity, "eccentricity");
...
__name(nadgrid, "nadgrid");
__name2(nadgrid, "nadgrid");
...
__name(readNTV2Grid, "readNTV2Grid");
__name2(readNTV2Grid, "readNTV2Grid");
...
__name(readGeotiffGrid, "readGeotiffGrid");
__name2(readGeotiffGrid, "readGeotiffGrid");
...
__name(getNadgrids, "getNadgrids");
__name2(getNadgrids, "getNadgrids");
...
__name(parseNadgridString, "parseNadgridString");
__name2(parseNadgridString, "parseNadgridString");
function degreesToRadians(degrees) {
  return degrees * Math.PI / 180;
}
__name(degreesToRadians, "degreesToRadians");
__name2(degreesToRadians, "degreesToRadians");
function secondsToRadians(seconds) {
  return seconds / 3600 * Math.PI / 180;
}
__name(secondsToRadians, "secondsToRadians");
__name2(secondsToRadians, "secondsToRadians");
...
__name2(detectLittleEndian, "detectLittleEndian");
...
__name(readSubgrids, "readSubgrids");
__name2(readSubgrids, "readSubgrids");
function mapNodes(nodes) {
  return nodes.map(function(r) {
    return [secondsToRadians(r.longitudeShift), secondsToRadians(r.latitudeShift)];
  });
}
__name(mapNodes, "mapNodes");
__name2(mapNodes, "mapNodes");
...
__name(readGridHeader, "readGridHeader");
__name2(readGridHeader, "readGridHeader");
...
__name(readGridNodes, "readGridNodes");
__name2(readGridNodes, "readGridNodes");
...
__name(compareDatums, "compareDatums");
__name2(compareDatums, "compareDatums");
...
__name(geodeticToGeocentric, "geodeticToGeocentric");
__name2(geodeticToGeocentric, "geodeticToGeocentric");
...
__name(geocentricToGeodetic, "geocentricToGeodetic");
__name2(geocentricToGeodetic, "geocentricToGeodetic");
...
__name(geocentricToWgs84, "geocentricToWgs84");
__name2(geocentricToWgs84, "geocentricToWgs84");
...
__name(geocentricFromWgs84, "geocentricFromWgs84");
__name2(geocentricFromWgs84, "geocentricFromWgs84");
function checkParams(type) {
  return type === PJD_3PARAM || type === PJD_7PARAM;
}
__name(checkParams, "checkParams");
__name2(checkParams, "checkParams");
...
__name(datum_transform_default, "datum_transform_default");
__name2(datum_transform_default, "default");
...
__name(applyGridShift, "applyGridShift");
__name2(applyGridShift, "applyGridShift");
...
__name(applySubgridShift, "applySubgridShift");
__name2(applySubgridShift, "applySubgridShift");
...
__name(nadInterpolate, "nadInterpolate");
__name2(nadInterpolate, "nadInterpolate");
...
__name(adjust_axis_default, "adjust_axis_default");
__name2(adjust_axis_default, "default");
...
__name(toPoint_default, "toPoint_default");
__name2(toPoint_default, "default");
function checkSanity_default(point) {
  checkCoord(point.x);
  checkCoord(point.y);
}
__name(checkSanity_default, "checkSanity_default");
__name2(checkSanity_default, "default");
...
__name(checkCoord, "checkCoord");
__name2(checkCoord, "checkCoord");
...
__name(checkNotWGS, "checkNotWGS");
__name2(checkNotWGS, "checkNotWGS");
...
__name(checkProj, "checkProj");
__name2(checkProj, "checkProj");
function proj4(fromProjOrToProj, toProjOrCoord, coord) {
  ...
  if (coord) {
    ...
    obj = {
       ...
       * @returns {T}
       */
      forward: /* @__PURE__ */ __name2(function(coords, enforceAxis) {
       ...
       * @returns {T}
       */
      inverse: /* @__PURE__ */ __name2(function(coords, enforceAxis) {
...
__name(forward2, "forward2");
__name2(forward2, "forward");
...
__name(inverse2, "inverse2");
__name2(inverse2, "inverse");
...
__name2(toPoint, "toPoint");
function degToRad(deg) {
  return deg * (Math.PI / 180);
}
__name(degToRad, "degToRad");
__name2(degToRad, "degToRad");
function radToDeg(rad) {
  return 180 * (rad / Math.PI);
}
__name(radToDeg, "radToDeg");
__name2(radToDeg, "radToDeg");
function LLtoUTM(ll) {
  var Lat = ll.lat;
  var Long = ll.lon;
  var a = 6378137;
...
__name(LLtoUTM, "LLtoUTM");
__name2(LLtoUTM, "LLtoUTM");
...
__name(UTMtoLL, "UTMtoLL");
__name2(UTMtoLL, "UTMtoLL");
...
__name(getLetterDesignator, "getLetterDesignator");
__name2(getLetterDesignator, "getLetterDesignator");
...
__name(get100kID, "get100kID");
__name2(get100kID, "get100kID");
...
__name(get100kSetForZone, "get100kSetForZone");
__name2(get100kSetForZone, "get100kSetForZone");
...
__name(getLetter100kID, "getLetter100kID");
__name2(getLetter100kID, "getLetter100kID");
...
__name(getEastingFromChar, "getEastingFromChar");
__name2(getEastingFromChar, "getEastingFromChar");
...
__name(getNorthingFromChar, "getNorthingFromChar");
__name2(getNorthingFromChar, "getNorthingFromChar");
...
__name(getMinNorthing, "getMinNorthing");
__name2(getMinNorthing, "getMinNorthing");
...
__name(pj_enfn_default, "pj_enfn_default");
__name2(pj_enfn_default, "default");
function pj_mlfn_default(phi, sphi, cphi, en) {
  cphi *= sphi;
  sphi *= sphi;
  return en[0] * phi - cphi * (en[1] + sphi * (en[2] + sphi * (en[3] + sphi * en[4])));
}
__name(pj_mlfn_default, "pj_mlfn_default");
__name2(pj_mlfn_default, "default");
var MAX_ITER = 20;
...
__name(pj_inv_mlfn_default, "pj_inv_mlfn_default");
__name2(pj_inv_mlfn_default, "default");
function init3() {
...
__name(forward3, "forward3");
__name2(forward3, "forward");
function inverse3(p) {
  var con, phi;
  var lat, lon;
...
__name(inverse3, "inverse3");
__name2(inverse3, "inverse");
...
__name(sinh_default, "sinh_default");
__name2(sinh_default, "default");
...
__name(hypot_default, "hypot_default");
__name2(hypot_default, "default");
function log1py_default(x) {
  var y = 1 + x;
  var z = y - 1;
  return z === 0 ? x : x * Math.log(y) / z;
}
__name(log1py_default, "log1py_default");
__name2(log1py_default, "default");
function asinhy_default(x) {
  var y = Math.abs(x);
  y = log1py_default(y * (1 + y / (hypot_default(1, y) + 1)));
  return x < 0 ? -y : y;
}
__name(asinhy_default, "asinhy_default");
__name2(asinhy_default, "default");
...
__name(gatg_default, "gatg_default");
__name2(gatg_default, "default");
...
__name(clens_default, "clens_default");
__name2(clens_default, "default");
function cosh_default(x) {
  var r = Math.exp(x);
  r = (r + 1 / r) / 2;
  return r;
}
__name(cosh_default, "cosh_default");
__name2(cosh_default, "default");
...
__name(clens_cmplx_default, "clens_cmplx_default");
__name2(clens_cmplx_default, "default");
function init4() {
...
__name(forward4, "forward4");
__name2(forward4, "forward");
function inverse4(p) {
...
__name(inverse4, "inverse4");
__name2(inverse4, "inverse");
...
__name(adjust_zone_default, "adjust_zone_default");
__name2(adjust_zone_default, "default");
...
__name(srat_default, "srat_default");
__name2(srat_default, "default");
var MAX_ITER2 = 20;
function init6() {
...
__name(forward5, "forward5");
__name2(forward5, "forward");
function inverse5(p) {
  var DEL_TOL = 1e-14;
  var lon = p.x / this.C;
  var lat = p.y;
...
__name(inverse5, "inverse5");
__name2(inverse5, "inverse");
var names7 = ["gauss"];
var gauss_default = {
  init: init6,
  forward: forward5,
...
__name(forward6, "forward6");
__name2(forward6, "forward");
function inverse6(p) {
...
__name(inverse6, "inverse6");
__name2(inverse6, "inverse");
...
__name(forward7, "forward7");
__name2(forward7, "forward");
function inverse7(p) {
  p.x -= this.x0;
  p.y -= this.y0;
...
__name(inverse7, "inverse7");
__name2(inverse7, "inverse");
...
__name(forward8, "forward8");
__name2(forward8, "forward");
function inverse8(p) {
  var Y = p.x - this.x0;
  var X = p.y - this.y0;
  var rotI = Y / this.R;
...
__name(inverse8, "inverse8");
__name2(inverse8, "inverse");
var names10 = ["somerc"];
var somerc_default = {
  init: init9,
  forward: forward8,
...
__name(isTypeA, "isTypeA");
__name2(isTypeA, "isTypeA");
function init10() {
...
__name(forward9, "forward9");
__name2(forward9, "forward");
function inverse9(p) {
...
__name(inverse9, "inverse9");
__name2(inverse9, "inverse");
...
__name(forward10, "forward10");
__name2(forward10, "forward");
...
__name(inverse10, "inverse10");
__name2(inverse10, "inverse");
var names12 = [
...
__name(forward11, "forward11");
__name2(forward11, "forward");
...
__name(inverse11, "inverse11");
__name2(inverse11, "inverse");
...
__name(mlfn_default, "mlfn_default");
__name2(mlfn_default, "default");
function e0fn_default(x) {
  return 1 - 0.25 * x * (1 + x / 16 * (3 + 1.25 * x));
}
__name(e0fn_default, "e0fn_default");
__name2(e0fn_default, "default");
function e1fn_default(x) {
  return 0.375 * x * (1 + 0.25 * x * (1 + 0.46875 * x));
}
__name(e1fn_default, "e1fn_default");
__name2(e1fn_default, "default");
function e2fn_default(x) {
  return 0.05859375 * x * x * (1 + 0.75 * x);
}
__name(e2fn_default, "e2fn_default");
__name2(e2fn_default, "default");
function e3fn_default(x) {
  return x * x * x * (35 / 3072);
}
__name(e3fn_default, "e3fn_default");
__name2(e3fn_default, "default");
function gN_default(a, e, sinphi) {
  var temp = e * sinphi;
  return a / Math.sqrt(1 - temp * temp);
}
__name(gN_default, "gN_default");
__name2(gN_default, "default");
function adjust_lat_default(x) {
  return Math.abs(x) < HALF_PI ? x : x - sign_default(x) * Math.PI;
}
__name(adjust_lat_default, "adjust_lat_default");
__name2(adjust_lat_default, "default");
...
__name(imlfn_default, "imlfn_default");
__name2(imlfn_default, "default");
function init13() {
  if (!this.sphere) {
...
__name(forward12, "forward12");
__name2(forward12, "forward");
...
__name(inverse12, "inverse12");
__name2(inverse12, "inverse");
...
__name(qsfnz_default, "qsfnz_default");
__name2(qsfnz_default, "default");
var S_POLE = 1;
var N_POLE = 2;
var EQUIT = 3;
var OBLIQ = 4;
...
__name(forward13, "forward13");
__name2(forward13, "forward");
...
__name(inverse13, "inverse13");
__name2(inverse13, "inverse");
...
__name(authset, "authset");
__name2(authset, "authset");
function authlat(beta, APA) {
  var t = beta + beta;
  return beta + APA[0] * Math.sin(t) + APA[1] * Math.sin(t + t) + APA[2] * Math.sin(t + t + t);
}
__name(authlat, "authlat");
__name2(authlat, "authlat");
...
__name(asinz_default, "asinz_default");
__name2(asinz_default, "default");
function init15() {
  if (Math.abs(this.lat1 + this.lat2) < EPSLN) {
    return;
  }
...
__name(forward14, "forward14");
__name2(forward14, "forward");
...
__name(inverse14, "inverse14");
__name2(inverse14, "inverse");
...
__name(forward15, "forward15");
__name2(forward15, "forward");
...
__name(inverse15, "inverse15");
__name2(inverse15, "inverse");
var names17 = ["gnom"];
var gnom_default = {
  init: init16,
  forward: forward15,
...
__name(iqsfnz_default, "iqsfnz_default");
__name2(iqsfnz_default, "default");
function init17() {
  if (!this.sphere) {
    this.k0 = msfnz_default(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts));
  }
}
__name(init17, "init17");
__name2(init17, "init");
...
__name(forward16, "forward16");
__name2(forward16, "forward");
...
__name(inverse16, "inverse16");
__name2(inverse16, "inverse");
var names18 = ["cea"];
var cea_default = {
  init: init17,
  forward: forward16,
...
__name(forward17, "forward17");
__name2(forward17, "forward");
...
__name(inverse17, "inverse17");
__name2(inverse17, "inverse");
...
__name(forward18, "forward18");
__name2(forward18, "forward");
...
__name(inverse18, "inverse18");
__name2(inverse18, "inverse");
...
__name(forward19, "forward19");
__name2(forward19, "forward");
...
__name(inverse19, "inverse19");
__name2(inverse19, "inverse");
...
__name(forward20, "forward20");
__name2(forward20, "forward");
...
__name(inverse20, "inverse20");
__name2(inverse20, "inverse");
...
__name(forward21, "forward21");
__name2(forward21, "forward");
...
__name(inverse21, "inverse21");
__name2(inverse21, "inverse");
...
__name(forward22, "forward22");
__name2(forward22, "forward");
...
__name(inverse22, "inverse22");
__name2(inverse22, "inverse");
...
__name(forward23, "forward23");
__name2(forward23, "forward");
...
__name(inverse23, "inverse23");
__name2(inverse23, "inverse");
...
__name(forward24, "forward24");
__name2(forward24, "forward");
...
__name(inverse24, "inverse24");
__name2(inverse24, "inverse");
...
__name(vincentyInverse, "vincentyInverse");
__name2(vincentyInverse, "vincentyInverse");
...
__name(vincentyDirect, "vincentyDirect");
__name2(vincentyDirect, "vincentyDirect");
function init26() {
  this.sin_p12 = Math.sin(this.lat0);
  this.cos_p12 = Math.cos(this.lat0);
  this.f = this.es / (1 + Math.sqrt(1 - this.es));
}
__name(init26, "init26");
__name2(init26, "init");
...
__name(forward25, "forward25");
__name2(forward25, "forward");
...
__name(inverse25, "inverse25");
__name2(inverse25, "inverse");
...
__name(forward26, "forward26");
__name2(forward26, "forward");
...
__name(inverse26, "inverse26");
__name2(inverse26, "inverse");
var names28 = ["ortho"];
var ortho_default = {
  init: init27,
  forward: forward26,
...
__name(forward27, "forward27");
__name2(forward27, "forward");
...
__name(inverse27, "inverse27");
__name2(inverse27, "inverse");
...
__name(qsc_fwd_equat_face_theta, "qsc_fwd_equat_face_theta");
__name2(qsc_fwd_equat_face_theta, "qsc_fwd_equat_face_theta");
...
__name(qsc_shift_lon_origin, "qsc_shift_lon_origin");
__name2(qsc_shift_lon_origin, "qsc_shift_lon_origin");
...
var RC1 = 1 / C1;
var NODES = 18;
var poly3_val = /* @__PURE__ */ __name2(function(coefs, x) {
  return coefs[0] + x * (coefs[1] + x * (coefs[2] + x * coefs[3]));
}, "poly3_val");
var poly3_der = /* @__PURE__ */ __name2(function(coefs, x) {
...
__name(newton_rapshon, "newton_rapshon");
__name2(newton_rapshon, "newton_rapshon");
function init29() {
  this.x0 = this.x0 || 0;
  this.y0 = this.y0 || 0;
  this.long0 = this.long0 || 0;
...
__name(forward28, "forward28");
__name2(forward28, "forward");
...
__name(inverse28, "inverse28");
__name2(inverse28, "inverse");
...
__name(init30, "init30");
__name2(init30, "init");
function forward29(p) {
  var point = geodeticToGeocentric(p, this.es, this.a);
  return point;
}
__name(forward29, "forward29");
__name2(forward29, "forward");
function inverse29(p) {
  var point = geocentricToGeodetic(p, this.es, this.a, this.b);
  return point;
}
__name(inverse29, "inverse29");
__name2(inverse29, "inverse");
...
__name(forward30, "forward30");
__name2(forward30, "forward");
...
__name(inverse30, "inverse30");
__name2(inverse30, "inverse");
...
__name(forward31, "forward31");
__name2(forward31, "forward");
...
__name(inverse31, "inverse31");
__name2(inverse31, "inverse");
...
__name(forward32, "forward32");
__name2(forward32, "forward");
...
__name(inverse32, "inverse32");
__name2(inverse32, "inverse");
...
function init35() {
  ...
  const parseParam = /* @__PURE__ */ __name2((name) => {
...
__name(init35, "init35");
__name2(init35, "init");
function forward33(p) {
  return this.projectionType.forward(this, p);
}
__name(forward33, "forward33");
__name2(forward33, "forward");
function inverse33(p) {
  return this.projectionType.inverse(this, p);
}
__name(inverse33, "inverse33");
__name2(inverse33, "inverse");
...
__name(createRotation, "createRotation");
__name2(createRotation, "createRotation");
...
__name(forwardOblique, "forwardOblique");
__name2(forwardOblique, "forwardOblique");
...
__name(forwardTransverse, "forwardTransverse");
__name2(forwardTransverse, "forwardTransverse");
...
__name(inverseOblique, "inverseOblique");
__name2(inverseOblique, "inverseOblique");
...
__name(inverseTransverse, "inverseTransverse");
__name2(inverseTransverse, "inverseTransverse");
...
__name(projs_default, "projs_default");
__name2(projs_default, "default");
...
var OPINET_BASE_URL = "https://www.opinet.co.kr/api/aroundAll.do";
var OPINET_OUTPUT_FORMAT = "json";
var RADIUS_MAX_METERS = 5e3;
var DEFAULT_RADIUS_METERS = 2e3;
var SORT_BY_PRICE = "1";
var SORT_BY_DISTANCE = "2";
var DEFAULT_SORT = SORT_BY_PRICE;
var DEFAULT_PRODUCT_CODE = "B027";
var PRODUCT_CODES = /* @__PURE__ */ new Set(["B027", "D047", "B034", "C004", "K015"]);
var CACHE_TTL_SECONDS = 90;
var EPSG_WGS84 = "EPSG:4326";
var KATEC = "KATEC";
var KATEC_DEF = "+proj=tmerc +lat_0=38 +lon_0=128 +k=0.9999 +x_0=400000 +y_0=600000 +ellps=bessel +towgs84=-115.80,474.99,674.11,1.16,-2.31,-1.63,6.43 +units=m +no_defs";
function getStringParam(url, key2) {
...
__name2(getStringParam, "getStringParam");
...
__name(clampRadiusMeters, "clampRadiusMeters");
__name2(clampRadiusMeters, "clampRadiusMeters");
...
function parseProductCode(prodcdRaw) {
  if (prodcdRaw && PRODUCT_CODES.has(prodcdRaw)) return prodcdRaw;
  return DEFAULT_PRODUCT_CODE;
}
__name(parseProductCode, "parseProductCode");
__name2(parseProductCode, "parseProductCode");
var proj4Initialized = false;
function ensureProj4Definitions() {
  if (proj4Initialized) return;
  lib_default.defs(KATEC, KATEC_DEF);
  proj4Initialized = true;
}
__name(ensureProj4Definitions, "ensureProj4Definitions");
__name2(ensureProj4Definitions, "ensureProj4Definitions");
function wgs84ToKatec(lat, lng) {
  ensureProj4Definitions();
  const [x, y] = lib_default(EPSG_WGS84, KATEC, [lng, lat]);
  return { x, y };
}
__name(wgs84ToKatec, "wgs84ToKatec");
__name2(wgs84ToKatec, "wgs84ToKatec");
function katecToWgs84(x, y) {
  ensureProj4Definitions();
  const [lng, lat] = lib_default(KATEC, EPSG_WGS84, [x, y]);
  return { lat, lng };
}
__name(katecToWgs84, "katecToWgs84");
__name2(katecToWgs84, "katecToWgs84");
function buildOpinetUrl(env, params2) {
  ...
  url.searchParams.set("x", params2.x);
  url.searchParams.set("y", params2.y);
  url.searchParams.set("radius", String(params2.radius));
  url.searchParams.set("prodcd", params2.prodcd);
  url.searchParams.set("sort", params2.sort);
  return url.toString();
}
__name(buildOpinetUrl, "buildOpinetUrl");
__name2(buildOpinetUrl, "buildOpinetUrl");
function buildCacheKey(params2) {
  return [
    "opinet:around",
    `x=${params2.x}`,
    `y=${params2.y}`,
    `radius=${params2.radius}`,
    `prodcd=${params2.prodcd}`,
    `sort=${params2.sort}`
  ].join("&");
}
__name(buildCacheKey, "buildCacheKey");
__name2(buildCacheKey, "buildCacheKey");
function jsonResponse(body, init36) {
...
__name(toStringOrNull, "toStringOrNull");
__name2(toStringOrNull, "toStringOrNull");
function isRecord(value) {
  return typeof value === "object" && value !== null && !Array.isArray(value);
}
__name(isRecord, "isRecord");
__name2(isRecord, "isRecord");
function findFirstStationArray(payload) {
  const visit = /* @__PURE__ */ __name2((node) => {
...
__name(findFirstStationArray, "findFirstStationArray");
__name2(findFirstStationArray, "findFirstStationArray");
function normalizeStations(stations) {
  return stations.map((s) => {
    const x = toNumber(s.GIS_X_COOR);
    const y = toNumber(s.GIS_Y_COOR);
    const wgs842 = x !== null && y !== null ? katecToWgs84(x, y) : { lat: null, lng: null };
    return {
...
__name(normalizeStations, "normalizeStations");
__name2(normalizeStations, "normalizeStations");
var onRequestGet = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (!x || !y) {
    return jsonResponse(
      {
        error: "Missing required query params. Provide either (x, y) in KATEC or (lat, lng) in WGS84."
      },
      { status: 400 }
    );
  }
  ...
  const opinetParams = { x, y, radius, prodcd, sort };
  ...
  return function(pathname) {
    ...
    var _loop_1 = /* @__PURE__ */ __name2(function(i2) {
      ...
      if (key2.modifier === "*" || key2.modifier === "+") {
        params2[key2.name] = m[i2].split(key2.prefix + key2.suffix).map(function(value) {
          return decode2(value, key2);
        });
      } else {
        params2[key2.name] = decode2(m[i2], key2);
      }
    }, "_loop_1");
...
function tokensToRegexp(tokens, keys, options) {
  ...
  var _a = options.strict, strict = _a === void 0 ? false : _a, _b = options.start, start2 = _b === void 0 ? true : _b, _c = options.end, end = _c === void 0 ? true : _c, _d = options.encode, encode2 = _d === void 0 ? function(x) {
    return x;
...
var pages_template_worker_default = {
  async fetch(originalRequest, env, workerContext) {
    ...
    const next = /* @__PURE__ */ __name2(async (input, init36) => {
      if (input !== void 0) {
        let url = input;
        if (typeof input === "string") {
          url = new URL(input, request.url).toString();
        }
        request = new Request(url, init36);
      }
      const result = handlerIterator.next();
      if (result.done === false) {
        const { handler, params: params2, path } = result.value;
        const context = {
...
function wrapExportedHandler(worker) {
  ...
  return {
    ...
    fetch(request, env, ctx) {
      const dispatcher = /* @__PURE__ */ __name2(function(type, init36) {
...
function wrapWorkerEntrypoint(klass) {
  ...
  return class extends klass {
    ...
    #dispatcher = /* @__PURE__ */ __name2((type, init36) => {
...
// .wrangler/tmp/bundle-RBMvDT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RBMvDT/middleware-loader.entry.ts
...
function wrapExportedHandler2(worker) {
  ...
  return {
    ...worker,
    fetch(request, env, ctx) {
      const dispatcher = /* @__PURE__ */ __name(function(type, init36) {
        if (type === "scheduled" && worker.scheduled !== void 0) {
...
function wrapWorkerEntrypoint2(klass) {
  ...
  return class extends klass {
    ...
    #dispatcher = /* @__PURE__ */ __name((type, init36) => {
      if (type === "scheduled" && super.scheduled !== void 0) {
        const controller = new __Facade_ScheduledController__2(
          Date.now(),
          init36.cron ?? "",
...
//# sourceMappingURL=functionsWorker-0.8328688811875196.js.map
